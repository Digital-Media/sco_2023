...
calibration_file_path ="tello_e01_calibration.xml"
...
camera_distortion = calibration_data.getNode("Distortion_Coefficients").mat()
...
while True:
    ...
    if ids is not None and ids[0] == id_to_find:
        ...
        roll_camera, pitch_camera, yaw_camera = rotationMatrixToEulerAngles(R_ct)
